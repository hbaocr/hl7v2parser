const segments = {
  ...
  //VHA defined segments
  ZSC: {
    desc: 'Clinic Stop Codes',
    fields: [
      {
        dt: 'SI',
        desc: 'Set ID',
      ...
      {
        dt: 'NM',
        desc: 'Clinic Cost Distribution Center',
        opt: 'R',
        rep: 0,
        len: 256
      },
      {
        dt: 'ST',
        desc: 'Clinic Currently Exempt from Classification',
        opt: 'R',
        rep: 0,
        len: 256
      }
